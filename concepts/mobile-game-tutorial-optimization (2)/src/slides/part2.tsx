      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-3">
        ...
        <Card accent="#FFB341">
          ...
          <ul className="mt-2 space-y-1 text-[13px] text-slate-400">
            ...
            <li>• Мастер-чек стадии — только из закрытых атомов</li>
          </ul>
        </Card>
        <Card accent="#59A7FF">
...
export function MotionSlide() {
  const items = [
    ...
    ['Смена стадии', 'токены палитры перекрашиваются твином 800 мс, девиз печатается'],
    ['Звук', '8 SFX: тап, улика, верно, неверно, награда, серия, стадия, Левиафан'],
  ];
  return (
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card accent="#34D399">
          ...
          <ul className="mt-2 space-y-1 text-[13px] text-slate-400">
            ...
            <li>• stageOf, balanceConfig, стор и миграции</li>
