...
export interface Palette {
  ...
  textN: number; subN: number; mutedN: number; cryptoN: number; infoN: number;
...
export const palettes: Record<EpochId, Palette> = {
  street: {
    ...
    text: '#f2f3f5', sub: '#b8bcc4', muted: '#7d838d', textN: 0xf2f3f5, subN: 0xb8bcc4, mutedN: 0x7d838d,
    cryptoN: 0xa855f7, info: '#45e0d0', infoN: 0x45e0d0, crypto: '#a855f7',
    paperN: 0x16181d, inkText: '#f2f3f5', inkSub: 'rgba(242,243,245,0.55)',
    fontHead: HEAD, fontUi: UI, fontMono: MONO, brick: true,
  },
  cabinet: {
    ...
    text: '#e9f2ff', sub: '#93a3bc', muted: '#62708a', textN: 0xe9f2ff, subN: 0x93a3bc, mutedN: 0x62708a,
    cryptoN: 0xb783ff, info: '#59a7ff', infoN: 0x59a7ff, crypto: '#b783ff',
    paperN: 0xe7dfd0, inkText: '#1c1916', inkSub: 'rgba(28,25,22,0.55)',
    fontHead: UI, fontUi: UI, fontMono: MONO, brick: false,
  },
  terminal: {
    ...
    good: '#3bde8a', goodN: 0x3bde8a, bad: '#ff596d', badN: 0xff596d, warn: '#ffb341', warnN: 0xffb341,
    text: '#e9f2ff', sub: '#93a3bc', muted: '#62708a', textN: 0xe9f2ff, subN: 0x93a3bc, mutedN: 0x62708a,
    cryptoN: 0xb783ff, info: '#31d6c4', infoN: 0x31d6c4, crypto: '#b783ff',
    paperN: 0x0c1323, inkText: '#e9f2ff', inkSub: 'rgba(147,163,188,0.7)',
    fontHead: MONO, fontUi: UI, fontMono: MONO, brick: false,
  },
  system: {
    ...
    good: '#3bde8a', goodN: 0x3bde8a, bad: '#ff596d', badN: 0xff596d, warn: '#ffb341', warnN: 0xffb341,
    text: '#f4f6fb', sub: '#9aa7c0', muted: '#5d6a85', textN: 0xf4f6fb, subN: 0x9aa7c0, mutedN: 0x5d6a85,
    cryptoN: 0xb783ff, info: '#59a7ff', infoN: 0x59a7ff, crypto: '#b783ff',
...
export function domainColor(p: Palette, domain: string): { n: number; s: string } {
  switch (domain) {
    case 'technical': return { n: p.accentN, s: p.accent };
    case 'risk': return { n: p.badN, s: p.bad };
    case 'context': return { n: p.infoN, s: p.info };
    case 'crypto': return { n: p.cryptoN, s: p.crypto };
    case 'human': return { n: p.warnN, s: p.warn };
    case 'cognitive': return { n: p.goodN, s: p.good };
    default: return { n: p.subN, s: p.sub };
  }
}
