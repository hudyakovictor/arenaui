...
export class SettingsScene extends Phaser.Scene {
  private get soundOn(){ return gameState.getFlagOr('sound_on', true); }
  private set soundOn(v:boolean){ gameState.setFlag('sound_on', v); }
  private get reducedMotion(){ return gameState.getFlagOr('reduced_motion', false); }
  private set reducedMotion(v:boolean){ gameState.setFlag('reduced_motion', v); }
