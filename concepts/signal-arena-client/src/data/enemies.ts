...
export const enemies: Enemy[] = [
  ...
  { id:'E18', name:'Stop-Hunt Kraken', domain:'risk', rankDanger:2, mode:'normal', stages:[
    ...
    {stage:4, level:87, requiredCards:[{cardId:'C2',rank:3},{cardId:'C10',rank:2},{cardId:'C14',rank:2}], sources:['chart','orderbook'], factor:'турнир, перенос', comboRequired:['K03'], layers:'S4 boiling'},
  ]},
  ...
  { id:'E08', name:'Headline Titan', domain:'context', rankDanger:2, mode:'normal', stages:[
    ...
    {stage:3, level:55, requiredCards:[{cardId:'C6',rank:2},{cardId:'C16',rank:1}], sources:['chart','news'], factor:'Correlation: новость по BTC, вопрос по альту', secondDomain:'context', comboRequired:['K07'], layers:'S3 silk threads'},
